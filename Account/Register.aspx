<%@ Page Title="Registration" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="FinanceManager.Account.Register" %>
    ...
    <hgroup class="title">
        ...
        <h2>Use the form below to create a new account.</h2>
                    ...
                    <fieldset>
                        ...
                        <asp:Button runat="server" ID="btnRegister" CommandName="MoveNext" Text="Register" OnClick="btnRegister_Click" />
                    </fieldset>
</asp:Content>